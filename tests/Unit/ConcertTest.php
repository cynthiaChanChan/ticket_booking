...
class ConcertTest extends TestCase
{
    ...
    function tickets_remaining_does_not_include_tickets_associated_with_an_order()
    {
        ...
        $concert->orderTickets('cindy@example.com', 20);
    ...
    function trying_to_purchase_more_tickets_than_remain_throws_an_exception()
    {
        ...
        try {
            $concert->orderTickets('cindy@example.com', 11);
    ...
    /** @test */
    function cannot_order_tickets_that_have_already_been_perchased()
    {
        $concert = factory(Concert::class)->create()->addTickets(10);

        $concert->orderTickets('cindy@example.com', 8);
        try {       
