        ...
        <div class="login">
            ...
            <form action="" method="POST">
                ...
                <div class="login__item">
                    ...
                    <input class="login__input" type="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="Email address">
                </div>
                <div class="login__item">
                    <div class="login__icon-box">
                    ...
                    <input class="login__input" type="password" name="password" value="" required placeholder="Password">
                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ticket_booking\resources\views/auth/login.blade.php ENDPATH**/ ?>