<div class="concet-warpper">
    <div class="concert-box">
        <div class="poster">
            <img src="<?php echo e(asset($concert->posterUrl())); ?>" alt="">
        </div>
        <div class="concert">
...
</div><?php /**PATH C:\wamp64\www\ticket_booking\resources\views/concerts/partials/card-with-poster.blade.php ENDPATH**/ ?>